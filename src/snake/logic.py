...
from snake import profiles, settings, utils
from snake.food import Food, PowerUp
from snake.obstacles import ObstacleManager
from snake.snake_entity import Snake
