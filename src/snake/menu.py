...
from snake.game import MOVE_EVENT, Game
from snake import profiles, settings, utils, video_config
from snake.audio_manager import AudioManager
from snake.settings import (
    ...
    STATE_MAIN,
    STATE_OPTIONS,
    STATE_OPTIONS_ADVANCED,
    STATE_OPTIONS_CONTROLS,
    STATE_OPTIONS_GAMEPLAY,
    STATE_OPTIONS_VISUAL,
    STATE_PLAY,
    STATE_PROFILES,
)
from snake.ui_components import (
    Button,
    InputOverlay,
    apply_all_settings,
    center_rect,
